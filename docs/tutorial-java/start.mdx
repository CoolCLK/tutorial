...
```java title="/src/java/clk/tutorial/Main.java" showLineNumbers
...
PS C:\Users\clk\Desktop> java .\Main.java
Hello world!
```

完成！不过只输出个“你好世界”似乎有点不咋地... 你也可以做个时钟，像这样：

```java title="/src/java/clk/tutorial/Timer.java" showLineNumbers
...
PS C:\Users\clk\Desktop> java .\Timer.java
