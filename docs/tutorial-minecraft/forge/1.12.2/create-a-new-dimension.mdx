...
我们在包 ```clk.tutorial.world``` ，创建几个类并像这样输入代码：

```java title="/src/main/java/clk/tutorial/world/DimensionType.java" showLineNumbers
package clk.tutorial.world;
...
```java title="/src/main/java/clk/tutorial/world/WorldProviderTutorial.java" showLineNumbers

package clk.tutorial.world;

import clk.tutorial.world.DimensionType;
...
```java title="/src/main/java/clk/tutorial/world/gen/ChunkGeneratorTutorial.java" showLineNumbers
package clk.tutorial.world.gen;
...
```java title="/src/main/java/clk/tutorial/TutorialMod.java" showLineNumbers
package clk.tutorial;
