...
```java title="/src/main/java/clk/tutorial/world/gen/ChunkGeneratorExample.java" showLineNumbers
...
```java title="/src/main/java/clk/tutorial/world/gen/ChunkGeneratorExample.java"
static {
...
```java title="/src/main/java/clk/tutorial/common/DimensionManager.java"
